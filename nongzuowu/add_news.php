...
function check(form){
	if(form.txt_title.value==""){
		alert("请输入农作物名称!");form.txt_title.focus();return false;
	}
	if(form.txt_content.value==""){
		alert("请输入农作物详细!");form.txt_content.focus();return false;
	}
                ...
                <div style="margin-top:100px;margin-left: 100px;">
                    <form name="form1" method="post" action="doAction.php" enctype="multipart/form-data">
                        <table width="100%" height="212" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                            <tr>
                                <td width="87" align="center">农作物代码：</td>
                                <td width="433" height="31"><input required name="nid" type="text" id="txt_id" size="40" ><font color="red">*</font></td>
                            </tr>
                            <tr>
                                <td width="87" align="center">农作物名称：</td>
                                <td width="433" height="31"><input required name="nname" type="text" id="txt_title" size="40" ><font color="red">*</font></td>
                            </tr>
                            <tr>
                                <td height="124" align="center">农作物生长：</td>
                                <td><textarea name="grow" cols="50" required rows="8" id="txt_content"></textarea></td>
                            </tr>
                             <tr>
                                <td height="124" align="center">农作物贮藏：</td>
                                <td><textarea name="zhucang" cols="50" required rows="8" id="txt_zhucang"></textarea></td>
                            </tr>
