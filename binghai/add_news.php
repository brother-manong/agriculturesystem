...
function check(form){
	if(form.txt_title.value==""){
		alert("请输入病害名称!");form.txt_title.focus();return false;
	}
	if(form.txt_zhengzhuang.value==""){
		alert("请输入病害症状!");form.txt_content.focus();return false;
	}
                    ...
                    <form name="form1" method="post" action="doAction.php" enctype="multipart/form-data">
                        <table width="100%" height="212" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                            <tr>
                                ...
                                <td width="433" height="31"><input required name="bid" type="text" id="txt_bid" size="40" ></td>
                            </tr>
                            <tr>
                                <td width="87" align="center">病害名称：</td>
                                <td width="433" height="31"><input required name="bname" type="text" id="txt_title" size="40" ><font color="red">*</font></td>
                            </tr>
                            <tr>
