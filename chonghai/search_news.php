...
<div class="content">
	<div class="con_left">
		<div class="con_left1">
			<div class="con_header"><div class="title"><span>虫害管理</span></div></div>
			<div class="">
	...
	<div class="con_right">
		<div>
			<div class="blog_list_wrap">
                ...
                <table border="1">
                    <tr>
                        <td width="10%" align="center">cid</td>
                        <td width="10%" align="center">图片</td>
                        <td width="20%" align="center">病毒名称</td>
                        <td width="25%" align="center">虫害症状</td>
                    ...
                    if (is_numeric($_GET['page'])) {                            //判断变量$page是否为数字，如果是则返回true
                        ...
                        $query = "select id from chonghai order by id desc";
                        ...
                        $sql = mysqli_query($conn, "select * from chonghai order by id desc limit $offset, $page_size");
                        $row = mysqli_fetch_object($sql);                       //获取查询结果集
                        if (!$row) {                                              //如果未检索到信息，则输出提示信息
                            echo "<font color='red'>暂无虫害信息!</font>";
                        }
                        do {
                            ?>
                            <tr>
                                <td style="font-size:14px; text-align:center"><input type="checkbox"  name="check[]" value="<?php echo $row->bid; ?>">&nbsp;&nbsp;&nbsp;<?php echo $row->cid; ?></td>
                                <td style="font-size:14px; text-align:left"><?php echo $row->cimage; ?></td>
                                <td style="font-size:14px; text-align:left"><?php echo $row->cname; ?></td>
                                ...
                                <td align="center"><a href="delete_news_ok.php?cid=<?php echo $row->cid; ?>">删除</a>||<a href="modify.php?id=<?php echo $row->id;?>">修改</a></td>
                            </tr>
                            <?php
