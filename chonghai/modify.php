...
$id = $_GET['id'];                                     //使用get方法接收欲编辑的虫害id
$sql = "select * from binghai where id=$id";       //从数据库中查找虫害id对应的虫害信息
$result = mysqli_query($conn,$sql);                  //检索虫害id对应的虫害信息
                    ...
                    <form name="form1" method="post" action="update_modify_ok.php" enctype="multipart/form-data">
                        <table width="550" height="212" border="0" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                            ...
                            <tr>
                                ...
                                <td width="433" height="31"><input name="cid" type="text" id="txt_bid" size="40" value="<?php echo $row->cid;?>" required>
                                <input name="id" type="hidden" value="<?php echo $row->id;?>">
                                </td>
                            </tr>
                            <tr>
                                <td width="87" align="center">虫害名称：</td>
                                <td width="433" height="31"><input name="cname" type="text" id="txt_bname" size="40" value="<?php echo $row->cname;?>" required>
                                <input name="id" type="hidden" value="<?php echo $row->id;?>">
                                </td>
                            </tr>
                            <tr>
